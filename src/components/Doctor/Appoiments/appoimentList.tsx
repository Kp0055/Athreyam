...
function AppointmentList() {
  ...
  const filteredList = filter ? list.filter((appointment) => appointment.status === filter) : list;
      ...
      <div className="flex justify-end mb-6 space-x-3">
        <button
          className={`px-4 py-2 rounded-lg font-semibold ${
            filter === "" ? "bg-gray-700 text-white" : "bg-gray-300 text-gray-800 hover:bg-gray-400"
          }`}
          onClick={() => setFilter("")}
        >
          All
        ...
        <button
          className={`px-4 py-2 rounded-lg font-semibold ${
            filter === "scheduled" ? "bg-blue-600 text-white" : "bg-blue-200 text-blue-800 hover:bg-blue-300"
          }`}
        ...
        <button
          className={`px-4 py-2 rounded-lg font-semibold ${
            filter === "cancelled" ? "bg-red-600 text-white" : "bg-red-200 text-red-800 hover:bg-red-300"
          }`}
        ...
        <button
          className={`px-4 py-2 rounded-lg font-semibold ${
            filter === "completed" ? "bg-green-600 text-white" : "bg-green-200 text-green-800 hover:bg-green-300"
          }`}
